...
extension TaskStatus {
    ...
    public static let completedTask = TaskStatus(task_id: "8681", build_id: "12345", owner: "some-org", repository: "some-repo", build_key: "some-key", task: "some-task", status: "completed", conclusion: "success", queued_at: Date().addingTimeInterval(-12), started_at: Date().addingTimeInterval(-12), finished_at: Date(), completed_at: Date(), node: "some-node")
    public static let failedTask = TaskStatus(task_id: "8682", build_id: "12345", owner: "some-org", repository: "some-repo", build_key: "some-key", task: "some-task", status: "completed", conclusion: "failure", queued_at: Date().addingTimeInterval(-12), started_at: Date().addingTimeInterval(-12), finished_at: Date(), completed_at: Date(), node: "some-node")
