...
extension TaskStatus {
    ...
    public static let inProgressTask = TaskStatus(task_id: "8680", build_id: "12345", owner: "some-org", repository: "some-repo", build_key: "some-key", task: "some-task", status: "in_progress", conclusion: nil, queued_at: Date(), started_at: Date(), finished_at: nil, completed_at: nil, node: "some-node")
